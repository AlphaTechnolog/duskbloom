	...
	subscribed("active", function()
		gtimer.delayed_call(function()
			container.animation:set_color({
				...
				indicator = client.active and beautiful.colors.accent or beautiful.colors.background,
				bg = client.active and beautiful.colors.light_background_10 or beautiful.colors.background,
			})
		end)
	end)
